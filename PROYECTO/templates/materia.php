                    ...
                    <div class="contenedor_form">
                        <div class="contenedor_interior">
                            <div class="contenedor_interior_left">
                                <label for="">NRC:</label>
                                <input class="input-text" type="text" type="text" value="<?php echo $nrc ?>" name="nrc" placeholder="Cambiar ID" required>
                            </div>
                            <div class="contenedor_interior_right">
                                <label for="">MATERIA:</label>
                                <input class="input-text" type="text" type="text" value="<?php echo $nombre ?>" name="materia" placeholder="Cambiar estado" required>
                            </div>
                            <div class="contenedor_interior_right">
                                <label for="">DOCENTE:</label>
                                <input class="input-text" type="text" type="text" value="<?php echo $docente ?>" name="docente" placeholder="Cambiar estado" required>
                            </div>
                        </div>
                    </div>
                    <div class="contenedor_botones">
                        <button type="submit" class="btn_format btn_enviar contenedor_interior_left" onclick="return ConfirmEstado()">Actualizar</button>
