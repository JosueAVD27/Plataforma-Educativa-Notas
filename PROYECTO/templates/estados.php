...
include("controladorAdmin/editarEstados.php");
?>
                    ...
                    <div class="contenedor_form">
                        <div class="contenedor_interior">
                            <div class="contenedor_interior_left">
                                <label for="">ID:</label>
                                <input class="input-text" type="text" type="text" value="<?php echo $idEstado ?>" name="idEstado" placeholder="Cambiar ID" required>
                            </div>
                            <div class="contenedor_interior_right">
                                <label for="">ESTADO:</label>
                                <input class="input-text" type="text" type="text" value="<?php echo $estado ?>" name="estado" placeholder="Cambiar estado" required>
                            </div>
                        </div>
                    </div>
